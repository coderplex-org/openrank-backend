...
from framework.tests.data import java_source_code_with_input, tc1, tc2, java_source_code_with_no_input
...
def test_with_no_input():
    ...
    assert 'Hello World' == out[0].output
